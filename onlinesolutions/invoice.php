...
-->
    ...
    <label style="font-size:15px">Company Name:</label><input name="companyname" style="width:300px;height:20px;border: none;font-weight: bold;" value=" Widget Corp," /> </br>
    ...
    <input name="customeraddress2" style="width:300px;height:20px;border: none;font-weight: bold;" value="Chennai-600 078" /> </br>
